...
async function tiktok(client, message){
    ...
    if(!args){
        await client.sendMessage(remoteJid, { text: stylizedChar(" ✨ GoldenBoy dєv said plz provide a tiktok link: Ex: tiktok https://vm.tiktok.com ✨")})
        return ;
    }
